...
const EarlyAccessForm: React.FC = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 bg-gray-50 relative" data-section="early-access">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 md:p-12 shadow-sm border border-gray-100">
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                <div>
                  <label htmlFor="email" className="block text-left text-sm font-semibold text-gray-700 mb-2 sm:mb-3">
                    Email Address
                  </label>
                  <input
                    type="email"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-primary-100 rounded-xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <span className="text-lg sm:text-xl md:text-2xl font-bold text-primary-600">1</span>
              </div>
              <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Priority Access</h4>
              <p className="text-sm sm:text-base text-gray-600">Be first in line when we launch with exclusive early access</p>
            </div>
            
            <div className="text-center">
              <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-primary-100 rounded-xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <span className="text-lg sm:text-xl md:text-2xl font-bold text-primary-600">2</span>
              </div>
              <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Exclusive Benefits</h4>
              <p className="text-sm sm:text-base text-gray-600">Special pricing and features only available to early adopters</p>
            </div>
            
            <div className="text-center sm:col-span-2 lg:col-span-1">
              <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-primary-100 rounded-xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <span className="text-lg sm:text-xl md:text-2xl font-bold text-primary-600">3</span>
              </div>
              <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Early Updates</h4>
              <p className="text-sm sm:text-base text-gray-600">Get the latest news and feature previews before anyone else</p>
            </div>
          </div>
        </motion.div>
      </div>
