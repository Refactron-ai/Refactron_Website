  ...
  const features = [
    {
      ...
      description: "Security scanning, code smells detection, complexity metrics, and dead code identification."
    },
    {
      icon: Zap,
      title: "Intelligent Refactoring",
      description: "Extract constants, reduce parameters, simplify conditionals, and auto-generate docstrings."
    },
    {
      icon: Shield,
      title: "Safe & Reliable",
      description: "Risk scoring, before/after previews, and 98 tests passing with 90% code coverage."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-4 sm:px-6 py-2 sm:py-3 mb-6 sm:mb-8">
            ...
            <span className="text-green-700 font-medium text-sm sm:text-base">Now Available</span>
          </div>
        </motion.div>
        ...
        >
          The intelligent code refactoring transformer that eliminates technical debt, 
          modernizes legacy code, and automates code refactoring with AI-powered intelligence.
        </motion.p>
        ...
        >
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-6 sm:p-8 md:p-12 max-w-4xl mx-auto">
            <div className="text-center mb-6 sm:mb-8">
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">Get Started in Seconds</h3>
              <p className="text-gray-300 text-base sm:text-lg">Install Refactron and start refactoring your Python code today</p>
            </div>
            ...
            <div className="bg-black rounded-lg p-4 sm:p-6 font-mono text-sm sm:text-base">
              <div className="flex items-center justify-between mb-4">
                ...
                <button 
                  onClick={() => navigator.clipboard.writeText('pip install refactron')}
        ...
        >
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
              Everything you need to transform your Python codebase with intelligent automation
            </p>
          </div>
