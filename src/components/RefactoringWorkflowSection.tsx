...
const RefactoringWorkflowSection = () => {
    ...
    const handleSequenceComplete = React.useCallback(() => {
        ...
        setTimeout(() => {
            ...
            setActiveTab((current) => {
                if (current === 'analyze') return 'refactor';
                if (current === 'refactor') return 'verify';
                if (current === 'verify') return 'analyze';
                return current;
            });
        }, 2000);
    }, []);
    ...
    const analyzeContent = [
        <TypingAnimation key="a1" duration={80}>pip install refactron</TypingAnimation>,
        <TypingAnimation key="a2" delay={1000} duration={80}>refactron init</TypingAnimation>,
        ...
        <TypingAnimation key="a7" delay={3000} duration={80}>refactron analyze src/</TypingAnimation>,
        ...
        <TypingAnimation key="a14" delay={5500} duration={80}>refactron metrics</TypingAnimation>,
    ...
    const refactorContent = [
        <TypingAnimation key="r1" duration={80}>refactron refactor src/</TypingAnimation>,
        ...
        <TypingAnimation key="r8" delay={3000} duration={80}>refactron autofix --safe</TypingAnimation>,
        ...
        <TypingAnimation key="r13" delay={5500} duration={80}>git diff</TypingAnimation>,
    ...
    const verifyContent = [
        <TypingAnimation key="v1" duration={80}>refactron report</TypingAnimation>,
        ...
        <TypingAnimation key="v6" delay={3000} duration={80}>refactron metrics</TypingAnimation>,
        ...
        <TypingAnimation key="v11" delay={5500} duration={80}>refactron rollback</TypingAnimation>,
        ...
        <TypingAnimation key="v14" delay={7500} duration={80}>refactron serve-metrics</TypingAnimation>,
    ...
    const tabInfo = {
        analyze: {
            title: "Analyze",
            description: "Refactron starts in read-only mode. You get clear insight into technical debt, complexity, and risk—without touching your code."
        },
        refactor: {
            title: "Refactor",
            description: "Refactron never rewrites your code blindly. You review suggestions first, and automation only applies changes that pass safety checks."
        },
        verify: {
            title: "Verify & Document",
            description: "Every refactor is verified, documented, and reversible. You get proof that behavior didn’t change—and a clear record of what did."
        }
    };
                    ...
                    <div className="flex gap-4">
                        {tabs.map((tab) => (
                            <button
                                ...
                                className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 relative overflow-hidden ${activeTab === tab.id
                            ...
                            >
                                ...
                                {activeTab === tab.id && (
                                    <motion.div
                                        className="absolute bottom-0 left-0 h-[2px] bg-black/10 w-full"
                                    >
                                        <motion.div
