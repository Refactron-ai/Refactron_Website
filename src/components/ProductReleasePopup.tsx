            ...
            <div className="w-full max-w-md max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6">
                <p className="text-gray-600 mb-4 leading-relaxed">
                  We're excited to announce that <strong>Refactron Library v0.1.0</strong> is now available on PyPI! 
                  Start transforming your Python code with AI-powered refactoring today.
                </p>
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  ...
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    <div className="text-lg font-bold text-purple-600">v0.1.0</div>
                ...
                <p className="text-xs text-gray-500 text-center mt-4">
                  Don't show this again • <button onClick={handleClose} className="text-primary-500 hover:text-primary-600 underline">Dismiss</button>
                </p>
              </div>
              </div>
            </div>
