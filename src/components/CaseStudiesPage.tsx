...
import { ArrowLeft, Target, AlertTriangle, Sparkles, Shield, ArrowRight } from 'lucide-react';
    ...
    <div className="relative pb-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 sm:p-10 mb-12">
          ...
          <p className="text-lg text-gray-600 leading-relaxed max-w-3xl">
            Refactron partners with engineering teams who are pushing the limits of legacy codebases, AI workloads,
            and compliance-heavy releases. Explore common pain points we attack first and the measurable outcomes we
            drive across sectors.
          </p>
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={stat.label} className="bg-gray-50 rounded-2xl px-4 py-5 text-center border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {industryChallenges.map(challenge => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-gray-900">{challenge.headline}</h3>
        ...
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900">Featured transformations</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {caseStudies.map(caseStudy => (
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-gray-900">{caseStudy.customer}</h3>
                ...
                <div className="grid grid-cols-3 gap-2 text-center">
                  {caseStudy.metrics.slice(0, 3).map(metric => (
                    <div key={metric.label} className="rounded-2xl border border-gray-100 px-2 py-3">
        ...
        <section className="bg-gray-900 text-white rounded-3xl p-8 sm:p-12 border border-gray-800">
          <div className="flex flex-col md:flex-row gap-6 md:items-center md:justify-between">
            <div>
              ...
              <h2 className="text-3xl font-bold mb-3">Ready to modernize your refactoring pipeline?</h2>
              <p className="text-gray-200 text-sm sm:text-base max-w-2xl">
                Share the problems slowing your engineers. We will map an actionable refactoring playbook in under two
                weeks, grounded in measurable KPIs.
              </p>
            </div>
